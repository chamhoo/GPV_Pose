...
flags.DEFINE_string('dataset', 'Real', 'CAMERA or CAMERA+Real')  #  'Real', 'CAMERA or CAMERA+Real'
flags.DEFINE_string('dataset_dir', '/home/leech/GPV_Pose/logs/data', 'path to the dataset')
flags.DEFINE_string('detection_dir', '/home/leech/GPV_Pose/logs/data/segmentation_results/', 'path to detection results')
...
flags.DEFINE_string('model_save', '/home/leech/GPV_Pose/logs/results/', 'path to save checkpoint')
# resume
flags.DEFINE_integer('resume', 1, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_model', '/home/leech/GPV_Pose/logs/torchmodels/gpv_pose_update.pth', 'path to the saved model')
